...
public class OceanActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.action_quit) {
            ...
            Intent intentBeatles = new Intent(OceanActivity.this, OffspringActivity.class);
            startActivity(intentBeatles);
            overridePendingTransition(R.animator.activity_open_translate, R.animator.activity_close_scale);
            finish();
        } else if (item.getItemId() == R.id.action_previous) {
            Intent intentBeatles = new Intent(OceanActivity.this, LanaDelReyActivity.class);
            startActivity(intentBeatles);
            overridePendingTransition(R.animator.activity_open_translate, R.animator.activity_close_scale);
            finish();
        } else if (item.getItemId() == R.id.action_home) {
            Intent intentBeatles = new Intent(OceanActivity.this, MainActivity.class);
            startActivity(intentBeatles);
            overridePendingTransition(R.animator.activity_open_translate, R.animator.activity_close_scale);
            finish();
        }
